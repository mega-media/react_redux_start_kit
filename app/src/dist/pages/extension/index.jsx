      ...
      <div>
        ...
        <div style={{ padding: '5px 10px 20px' }}>
          ...
          <ol style={{ padding: '5px 20px', lineHeight: '30px' }}>
            <li>
              第一層資料夾對應的是 <label>app/core</label> 底下的路徑。
              action.effects 即是 <label>app/core/action/effects/</label>
            </li>
            <li>
