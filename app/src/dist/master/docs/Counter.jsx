  ...
  desc: (
    <div>
      ...
      <div>
        ...
        <ul>
          <li>
            Redux 基於 Flux 所衍伸的應用架構，包含四個主要角色：
            <label>Action</label>、<label>Reducer</label>、<label>Store</label>
            與<label>View</label>
          </li>
          <li>
            角色之間的對應關係如上圖所示，任何操作流程皆為
            <label>單向資料流(Unidirectional data flow)</label>
          </li>
          <li>
            每個角色有各自的負責職責：
            <ol>
              ...
              <li>
                <b>Store : </b>
                由多個 states 組成，根據 Reducers 回傳的資料結果，寫進對應的
                state 中
              </li>
              <li>
                <b>Views : </b>
                當監聽的 state 發生改變，即觸發 view
                進行處理（顯示資訊或其他邏輯處理）
              </li>
            </ol>
          </li>
      ...
      <ul>
        <li>
          使用快捷鍵
          <label>ctrl</label> + <label>h</label> 展開系統掛載的開發輔助工具
        </li>
        <li>
          快捷鍵
          <label>ctrl</label> + <label>g</label> 變更輔助工具位置
        </li>
        <li>
          Redux devTools :{' '}
