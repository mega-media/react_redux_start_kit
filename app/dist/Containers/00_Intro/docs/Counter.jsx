        ...
        <div>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>
                        角色之間的對應關係如上圖所示，任何操作流程皆為<label>單向資料流(Unidirectional data flow)</label>
                    </li>
                    <li>
                        每個角色有各自的負責職責：
                        <ol>
            ...
            <ul>
                ...
                <li>Redux devTools : <a target="_blank" href="https://github.com/gaearon/redux-devtools">
                    {`https://github.com/gaearon/redux-devtools`}</a>
                </li>
            </ul>
            <h5>☆ Reducer 的設定</h5>
            <ul>
                <li>
                    與 Router 設定一同寫在 Config.js 中
                </li>
            </ul>
            <h5>☆ 核心檔案 - BaseView</h5>
            <ul>
                ...
                <li>
                    connectToView 方法：綁定 state 與 View
                </li>
            </ul>
